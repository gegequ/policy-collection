...
- 📊 行情：必须查上方实时行情表。有该板块→写具体价格+涨跌幅。找不到→写「行情表中无此板块」。
  板块→行情映射：金融→中证银行/证券，科技→科创50，消费→中证消费，医药→中证医药，军工→中证军工，半导体→半导体指数，新能源→中证新能源/CS新能车，数字经济→数字经济ETF(净值)，机器人→机器人ETF(净值)，光伏→光伏ETF(净值)，建材→建材ETF(净值)，电力→电力ETF(净值)，基建→中证基建
